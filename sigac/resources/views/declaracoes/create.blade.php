...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h2">Criar Nova Declaração</h1>
        ...
        <form action="{{ route('declaracoes.store') }}" method="POST">
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <textarea class="form-control @error('conteudo') is-invalid @enderror" id="conteudo" name="conteudo" rows="6" required>{{ old('conteudo') }}</textarea>
                    @error('conteudo')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
